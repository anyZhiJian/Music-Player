...
{
    temperature_sensor_config_t temp_sensor_cfg = TEMPERATURE_SENSOR_CONFIG_DEFAULT(-10, 80);
...
{
    float tsens_value = 0;
    ESP_ERROR_CHECK(temperature_sensor_get_celsius(temperature_sensor, &tsens_value));
    return tsens_value;
}